  ...
  return (
    <div name='work' className='text-white mt-40 ml-6 w-full md:ml-0'>
        ...
        <div className='flex flex-col gap-4'>
            ...
            {/* card 1 */}
            <div className={scrollPosition > 1200 ? 'z-50 right-14 lg:relative bottom-5 ease-in duration-7' : 'z-50 lg:relative right-[-130%] bottom-5 ease-in duration-7'}>
            ...
            <div className={scrollPosition > 1500 ? 'z-50 lg:relative right-14 bottom-5 ease-in duration-7' : 'z-50 lg:relative right-[-130%] bottom-5 ease-in duration-7'}>
            <div className='bg-[var(--primary-1)] w-[90%] lg:w-[180%] lg:ml-12 mx-auto'>
                <div className='flex flex-col md:flex-row  lg:w-[50%] p-4'>
                    <div className='basis-1/2'>
            ...
            {/* card 3 */}
            <div className={scrollPosition > 1800 ? 'z-50 lg:relative right-14 bottom-5 ease-in duration-7' : 'z-50 lg:relative right-[-130%] bottom-5 ease-in duration-7'}>
            <div className='bg-[var(--primary-1)] w-[90%] lg:w-[180%] lg:ml-12 mx-auto'>
                <div className='flex flex-col md:flex-row  lg:w-[50%] p-4'>
                    <div className='basis-1/2'>
            ...
            {/* card 4 */}
            <div className={scrollPosition > 2100 ? 'z-50 lg:relative right-14 bottom-5 ease-in duration-7' : 'z-50 lg:relative right-[-130%] bottom-5 ease-in duration-7'}>
            <div className='bg-[var(--primary-1)] w-[90%] lg:w-[180%] lg:ml-12 mx-auto'>
                <div className='flex flex-col md:flex-row  lg:w-[50%] p-4'>
                    <div className='basis-1/2'>
