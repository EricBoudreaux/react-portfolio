...
const SideBar = () => {
  return (
    <div className='bg-[var(--light)] pt-12 pl-4 h-[4368px]'>
        ...
        <img src={AboutEmote} alt="my cartoon head" className='w-[90%] mx-auto mt-[100px]' />
        <img src={SkillsEmote} className='w-[80%] mx-auto mt-[1600px]' alt="" />
    </div>  
  )
}
